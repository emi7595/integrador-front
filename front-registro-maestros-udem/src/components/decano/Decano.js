...
import TablaInfoDecano from '../tablas/tablasInfo/decano/TablaInfoDecano';
import TablaDecano from '../tablas/TablaDecano';
                        ...
                        <div className="container px-0 pt-3">
                            <div className="row m-0 justify-content-center mt-3">
                                <div className="col-12 text-center">
                                    ...
                                    <TablaInfoDecano escuela={schoolName}></TablaInfoDecano>
                                    <div className="mb-4" ></div>
                                    <TablaDecano data={data}></TablaDecano>
