...
const TablaVicerrectorEscuela = (props) => {
                ...
                <TableBody>
                    {props.data?.map((departamento) => (
                        <StyledTableRow key={departamento.departmentId}>
                            ...
                            <StyledTableCell align="right"><a onClick={() => { departamento.average === -1 ? navigate("/vicerrector/escuela") : navigate("/vicerrector/reporte-departamento", { state: departamento }) }}><BsThreeDots className="icono-detalle"></BsThreeDots></a></StyledTableCell>
                        </StyledTableRow>
                    ))}
                </TableBody>
            </Table>
...
export default TablaVicerrectorEscuela;