								...
								<div className="col-12 text-center">
									<div className="row m-0 black-card mb-2">
										...
										<div className="form-reportar">
											<form className="form-reportar-labels pt-5 pb-5" onSubmit={handleSubmit}>
											...
											<div className='dropdown'>
											<label for="fecha" className='label'>Clave:</label>
											...
											<label for="horario" className='label'>Horario:</label>
												...
												<button type="submit" className='boton-registrar mb-4'>Enviar</button>
											</form>
